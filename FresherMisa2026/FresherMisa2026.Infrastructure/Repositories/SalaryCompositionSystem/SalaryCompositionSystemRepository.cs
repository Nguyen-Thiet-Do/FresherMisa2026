...
namespace FresherMisa2026.Infrastructure.Repositories
{
        ...
        : BaseRepository<SalaryCompositionSystemEntity>, ISalaryCompositionSystemRepository
    {
        ...
        // Pre-compute mệnh đề loại trừ TPL hệ thống đã được kế thừa — không phụ thuộc input người dùng
        private static readonly string ExcludeInheritedClause = string.Format(
            CultureInfo.InvariantCulture,
            SalaryQueries.ExcludeInheritedSystemCompositionsTemplate,
            (int)SalaryCompositionSource.InheritedFromSystem);
